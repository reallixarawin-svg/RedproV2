...
$window.FindName("BtnAntiNet").Add_Click({ Start-Process -FilePath (Join-Path $dekDir "Network\AntiNettV2.bat") })
$window.FindName("BtnDscpFse").Add_Click({ Start-Process -FilePath (Join-Path $dekDir "Network\DSCP & FSE.bat") })
